...
const navSections: Array<{
  title?: string;
  items: Array<{ label: string; href: string; icon: typeof Package }>;
}> = [
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Cart Abandonment", href: "/admin/cart-abandonment", icon: BarChart3 },
      ...
      <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
        ...
        >
          <div className="flex h-full flex-col">
            ...
            {/* Footer */}
            <div className="shrink-0 space-y-3 border-t border-zinc-200 px-3 py-4 dark:border-zinc-800">
              <Link
                href="/studio"
                target="_blank"
                onClick={() => setSidebarOpen(false)}
